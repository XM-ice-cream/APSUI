...
import { ISubmitInfo, ISearchInfo } from '@/entity/maintenance/workDay'
...
export const getPageListReq = (data: IPagination<ISearchInfo>) => {
	return Fetch({
		...
		url: '/api/apscenter/v1/workDay/getpagelist',
		method: 'post',
		data,
	})
}
...
export const addReq = (data: ISubmitInfo) => {
	return Fetch({
		baseUrl: 'http://10.32.44.91:8080',
		url: '/api/apscenter/v1/workDay/addworkday',
		method: 'post',
		data,
	})
}
...
export const updateReq = (data: ISubmitInfo) => {
	return Fetch({
		baseUrl: 'http://10.32.44.91:8080',
		url: '/api/apscenter/v1/workDay/modifyworkday',
		method: 'put',
		data,
	})
}
...
export const deteteReq = (data: ISubmitInfo) => {
	return Fetch({
		baseUrl: 'http://10.32.44.91:8080',
		url: '/api/apscenter/v1/workDay/deleteworkday',
		method: 'delete',
		data,
	})
}
