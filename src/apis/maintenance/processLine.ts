...
import { ISubmitInfo, ISearchInfo } from '@/entity/maintenance/processLine'
...
export const getPageListReq = (data: IPagination<ISearchInfo>) => {
	return Fetch({
		...
		url: '/api/apscenter/v1/processline/getpagelist',
		method: 'post',
		data,
	})
}
...
export const addReq = (data: ISubmitInfo) => {
	return Fetch({
		baseUrl: 'http://10.32.44.91:8080',
		url: '/api/apscenter/v1/processline/addprocessline',
		method: 'post',
		data,
	})
}
...
export const updateReq = (data: ISubmitInfo) => {
	return Fetch({
		baseUrl: 'http://10.32.44.91:8080',
		url: '/api/apscenter/v1/processline/modifyprocessline',
		method: 'put',
		data,
	})
}
...
export const deteteReq = (data: ISubmitInfo) => {
	return Fetch({
		baseUrl: 'http://10.32.44.91:8080',
		url: '/api/apscenter/v1/processline/deleteprocessline',
		method: 'delete',
		data,
	})
}
