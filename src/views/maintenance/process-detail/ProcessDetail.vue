...
//entity
import { ISearchInfo ,ISubmitInfo,ISearchReq } from "@/entity/maintenance/processDetail";
import { IPagination,GlobalVariableType } from"@/entity/common";
//api
import { getPageListReq ,deteteReq ,addReq ,updateReq} from "@/apis/maintenance/processDetail";
...
// 查询
const pageLoad = ()=>{
    const {eqpId,pageIndex,pageSize} = req.value;
...
const sumbitClick =(row :ISubmitInfo)=>{
    const { id,eqpId,processId,qty,idx} = row;
    const obj = {  id, eqpId,processId,qty,idx };
