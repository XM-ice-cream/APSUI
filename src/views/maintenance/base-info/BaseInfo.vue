<script lang="ts" setup>
   ...
   // 查询
    ...
    const  updateBase = (row: BaseInfo)=> {  
        ...
        //runtime-core.esm-bundler.js:218 Uncaught TypeError: Cannot create property 'value' on boolean 'false'    
        //解决方案：去掉value即可
...
<template>
  <div class="base-info-box">
    ...
    <UpdateBase ref="updateBaseRef" :data="selectObj"  @reLoad="pageLoad"/>
  </div>
</template>
