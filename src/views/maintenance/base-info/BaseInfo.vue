...
<template>
	...
	<ViewData ref="viewDataRef" :Column="Column" :SearchForm="SearchForm" :loading="Boolean(tableConfig.loading)" :req="req" :tableData="tableData" @pageLoad="pageLoad" @deleteClick="deleteClick" @updateClick="updateClick" />
	<!-- 新增、编辑 、删除-->
